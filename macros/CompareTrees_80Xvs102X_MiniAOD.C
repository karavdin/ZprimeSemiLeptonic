...
void CompareTrees_80Xvs102X(TString var_name="MET",TString branch_name_old="met_pt",TString branch_name_new="slimmedMETs.pt()", bool isFloat=false, int nbins=10, double minx=0,double maxx=10, int maxevents=100){
  gStyle->SetOptStat(0);
